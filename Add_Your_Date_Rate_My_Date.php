   ...
   <div id="header">
    ...
    <div id="content">
        <center>
			...
			<form enctype="multipart/form-data" method="post" id="add_form" action="Add_Your_Date_Extra_Rate_My_Date.php" onsubmit="return false">
				...
				<label for="birth"> Their birth year:
					<input type="number" name="birth" id="birth" value="" required>
				</label>
				...
				<input type="button" id="send" value="Submit" onclick="birthyear()">
			</form>
		</center>
    </div>
  </body>
